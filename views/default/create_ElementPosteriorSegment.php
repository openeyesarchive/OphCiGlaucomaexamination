...
<div class="ElementPosteriorSegment ondemand">
    ...
    <h4 class="elementTypeName">
        <a href="#" id="button1" onClick="toggleDivWithImages('<?php echo $element->elementType->class_name ?>', '<?php echo $element->elementType->class_name ?>_image','<?php echo $this->assetPath?>/img/discloseSmallOpen16.gif', '<?php echo $this->assetPath?>/img/discloseSmallClose16.gif'); return false;" class="<?php echo $element->elementType->class_name ?>_link" title="Click to reveal Fields to confrontation and enter data for it">
            <img id="<?php echo $element->elementType->class_name ?>_image" src="<?php echo $this->assetPath?>/img/discloseSmallClose16.gif"/> Posterior Segment
        </a>
    ...
    <div id="<?php echo $element->elementType->class_name ?>" style="display:none" class="eventDetail">
        ...
        <div class="splitElement clearfix">
            <div class="left" style="width:50%;">
                <?php
                $this->widget('application.modules.eyedraw.OEEyeDrawWidgetPosteriorSegmentGlaucoma', array(
                    'identifier' => 'PosteriorSegmentRight',
                    'side' => 'R',
                    'mode' => 'edit',
                    'size' => 200,
                    'model' => $element,
            ...
            <div class="right" style="width:50%;">
                <?php
                $this->widget('application.modules.eyedraw.OEEyeDrawWidgetPosteriorSegmentGlaucoma', array(
                    'identifier' => 'PosteriorSegmentLeft',
                    'side' => 'L',
                    'mode' => 'edit',
                    'size' => 200,
                    'model' => $element,
                    ...
                    <tr>
                        <td>
                            ...
                            <input value="Add to Report" type="button"
                                   ...
                                   onclick="addToReport(ed_drawing_edit_PosteriorSegmentRight, 
                               ElementPosteriorSegment_description_right); return false;" >
                            </div>
                        </td>
                        <td>
                            <div class="eventDetail">
                            <input value="Reset" type="button" title="Clear drawing and start again"
                                   onclick="resetEdit(ed_drawing_edit_PosteriorSegmentRight,
                               ElementPosteriorSegment_description_right); return false;" />
                            </div>
                        </td>
                        <td>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <input value="Add to Report" type="button"
                                   title="Extracts description and diagnosis from drawingEdit" 
                                   onclick="addToReport(ed_drawing_edit_PosteriorSegmentLeft, 
                               ElementPosteriorSegment_description_left); return false;" >
                            </div>
                        </td>
                        <td>
                            <div class="eventDetail">
                            <input value="Reset" type="button" title="Clear drawing and start again"
                                   onclick="resetEdit(ed_drawing_edit_PosteriorSegmentLeft,
                               ElementPosteriorSegment_description_left); return false;" />
                            </div>
                        </td>
                        <td>
...
<script type="text/javascript">
     ...
     */
    var node = document.getElementById('div_ElementPosteriorSegment_description_right');
    node.removeChild(node.childNodes[1]);
    var node = document.getElementById('div_ElementPosteriorSegment_description_left');
    node.removeChild(node.childNodes[1]);
</script>