 ...
 */
class ElementGonioscopy extends EyeDrawBase {
    /** */
    ...
    public function tableName() {
        return 'et_ophciglaucomaexamination_gonioscopy';
    }
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'event_id' => 'Event',
            'van_herick_left' => 'Van Herick (left)',
            'van_herick_right' => 'Van Herick (right)',
            'gonio_left' => 'Left',
            'gonio_right' => 'Right',
